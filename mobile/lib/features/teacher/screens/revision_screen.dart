          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    const Icon(Icons.repeat_rounded, color: AppTheme.accentGold, size: 28),
              ...
              SegmentedButton<int>(
                segments: const [
                  ButtonSegment(
                    value: 0,
                    label: Text('حسب السورة'),
                    icon: Icon(Icons.menu_book_rounded),
                  ),
                  ButtonSegment(
                    value: 1,
                    label: Text('حسب الجزء'),
                    icon: Icon(Icons.layers_rounded),
                  ),
                ],
                selected: {_revisionMode},
                onSelectionChanged: (set) {
                  setState(() {
                    _revisionMode = set.first;
                  });
                },
              ),
              const SizedBox(height: 16),
              ...
              ElevatedButton(
                ...
                child: _isSaving
                    ...
                    : const Text('حفظ وتسجيل المراجعة'),
              ),
            ],
          ),
        ),
