...
export default function StudentManagement({ currentUser }: { currentUser?: any } = {}) {
  ...
  // Initial Mock State with 6 highly structured students representing classes
  const [students, setStudents] = useState<Student[]>([
    {
      ...
      commitmentScore: 96,
      lastExamScore: 99,
      lastExamName: 'سورة البقرة والنساء التراكمي',
      attendanceRate: 99,
      trend: 'up',
      timeline: [
        ...
        { date: '01/01/1445', title: 'تعديل خطة التمسيع', desc: 'تعديل الخطة إلى مسار التميز السريع بمعدل صفحتين في اليوم.', author: 'الشيخ عبد الرحمن السعيد' }
      ],
      goals: [
        { type: 'hifz', title: 'كمية الحفظ الشهري', target: 30, actual: 32, unit: 'صفحة', status: 'achieved', lastUpdated: '18/06/2026' },
        { type: 'revision', title: 'المراجعة التراكمية اليومية', target: 5, actual: 5, unit: 'أجزاء', status: 'achieved', lastUpdated: '20/06/2026' },
        { type: 'attendance', title: 'نسبة الحضور بالمسجد', target: 95, actual: 99, unit: '%', status: 'achieved', lastUpdated: '22/06/2026' }
      ],
      interventions: [],
      decisions: [
        { id: 'E-001', title: 'نقله لمسار كبار الحفاظ والمنح التمكينية', reason: 'تحقيق درجة امتياز مع مرتبة الشرف في عموم الأجزاء العشرة الأخيرة.', auth: 'المشرف التعليمي', date: '10/05/1445' }
      ],
      notes: [
        { id: '1', text: 'طالب متميز جداً سريع الاستيعاب يحتاج دائماً لمراجعة الحروف والمخارج لتلافي اللحن الخفي.', category: 'educational', author: 'أ. عبد الرحمن السعيد', date: '22/05/2026' }
      ],
      communicationLog: [
        { date: '12/06/2026', method: 'رسالة واتساب', note: 'تهنئة ولي الأمر بحصول ابنه على أعلى نقاط تقييم هذا الأسبوع.', officer: 'المرشد الطلابي' }
      ],
      achievements: [
        { date: '20/04/1445', title: 'إتمام حفظ الأجزاء العشرة الأولى', category: 'حفظ مقرر' }
      ]
    },
    {
      id: 'ST-000002',
      name: 'باسل بن عبدالكريم الوهيبي',
      circle: 'حقة حفص للإتقان (متقدم)',
      teacher: 'أ. حازم عمر الحركي',
      status: 'active',
      joinDate: '20/11/1444',
      age: 14,
      parentName: 'عبدالكريم بن سليمان الوهيبي',
      parentPhone: '0567123490',
      relationship: 'أب',
      school: 'متوسطة الإمام ابن عامر',
      academicIndicator: 'yellow',
      riskFlags: ['توقف عن التقدم'],
      hifzRate: 85,
      muraajaaRate: 80,
      commitmentScore: 82,
      lastExamScore: 84,
      lastExamName: 'نصف فصلي جزء عم وتبارك والقد سمع',
      attendanceRate: 88,
      trend: 'stable',
      timeline: [
        { date: '20/11/1444', title: 'التسجيل والانتساب', desc: 'انتسب الطالب للحلقة وبدء مسار التحفيظ العادي.', author: 'الإدارة' }
      ],
      goals: [
        { type: 'hifz', title: 'كمية الحفظ الشهري', target: 20, actual: 16, unit: 'صفحة', status: 'pending', lastUpdated: '15/06/2026' },
        { type: 'revision', title: 'المراجعة اليومية لحلقتين التسميع', target: 3, actual: 2, unit: 'أجزاء', status: 'delayed', lastUpdated: '18/06/2026' }
      ],
      interventions: [
        { id: 'INT-01', type: 'support_plan', title: 'خطة تقوية فردية للمراجعة المكثفة', reason: 'ضعف أداء في المراجعة لعدم التكرار بالمستند والمتابعة المنزلية.', authority: 'مشرف الحلقات', date: '21/06/2026', status: 'active' }
      ],
      decisions: [],
      notes: [
        { id: '2', text: 'يحتاج تركيز بالمراجعة بالبيت، تم إرسال رسالة لولي الأمر بضرورة سبر المراجعة.', category: 'instructional', author: 'أ. حازم عمر', date: '21/06/2026' }
      ],
      communicationLog: [
        { date: '21/06/2026', method: 'اتصال هاتفي مع الأب', note: 'توضيح تدني مستوى باسل في المراجعة والدعوة لزيارة الملتقى.', officer: 'أستاذ حازم' }
      ],
      achievements: []
    },
    {
      ...
      circle: 'شعبة الفقه والعقيدة (متوسط)',
      teacher: 'يونس الدوسري',
      status: 'active',
      joinDate: '10/01/1445',
      age: 15,
      parentName: 'يوسف بن تركي الدوسري',
      parentPhone: '0543322110',
      relationship: 'أب',
      school: 'ثانوية المنهل',
      academicIndicator: 'red',
      riskFlags: ['خطر الانقطاع', 'غياب متكرر'],
      hifzRate: 45,
      muraajaaRate: 50,
      commitmentScore: 40,
      lastExamScore: 62,
      lastExamName: 'استفتاح سورة آل عمران',
      attendanceRate: 65,
      trend: 'down',
      timeline: [
        { date: '10/01/1445', title: 'التسجيل والقبول', desc: 'تم إدراج الطالب بالملتقى بالتنسيق مع والده.', author: 'شؤون الطلاب' }
      ],
      goals: [
        { type: 'hifz', title: 'كمية الحفظ الشهري', target: 15, actual: 4, unit: 'صفحة', status: 'delayed', lastUpdated: '10/06/2026' },
        { type: 'attendance', title: 'الحضور العام بالمسجد', target: 90, actual: 65, unit: '%', status: 'delayed', lastUpdated: '22/06/2026' }
      ],
      interventions: [
        { id: 'INT-02', type: 'counseling', title: 'تحويل الطالب للمستشار السلوكي والتربوي بالملتقى', reason: 'التأخر الدراسي المستمر والغياب المتكرر دون مبرر.', authority: 'اللجنة التربوية', date: '15/06/2026', status: 'active' }
      ],
      decisions: [
        { id: 'E-002', title: 'إنذار أول لولي الأمر بخروج الطالب في حال الغياب', reason: 'المستويات المتدنية وتكرار الغياب بدون وثائق مبررة.', auth: 'مدير شؤون الطلاب', date: '18/06/2026' }
      ],
      notes: [
        { id: '3', text: 'يتغيب كثيراً وباهت الاهتمام، يتطلب تدخلاً أسرياً فوريّا لإنقاذ خطة الحفظ.', category: 'behavioral', author: 'الشيخ يونس الدوسري', date: '19/06/2026' }
      ],
      communicationLog: [
        { date: '19/06/2026', method: 'رسالة إدارية رسمية', note: 'خطاب إنذار أخير برقم صادر بالبريد والواتساب بسب الغياب المتكرر للحافظ معاذ.', officer: 'السكرتارية الإدارية' }
      ],
      achievements: []
    },
    {
      ...
      circle: 'حقة الأشبال الصغار (أ)',
      teacher: 'محمد معوض النخيلي',
      status: 'inactive',
      joinDate: '02/05/1445',
      age: 11,
      parentName: 'منصور بن تركي الشمري',
      parentPhone: '0533009988',
      relationship: 'أب',
      school: 'ابتدائية قرطبة الأهلية',
      academicIndicator: 'red',
      riskFlags: ['تراجع سريع في الأداء', 'ضعف في الالتزام'],
      hifzRate: 30,
      muraajaaRate: 35,
      commitmentScore: 25,
      lastExamScore: 50,
      lastExamName: 'الأجزاء الخمسة المقررة لسن الحضانة',
      attendanceRate: 40,
      trend: 'down',
      timeline: [
        { date: '02/05/1445', title: 'التسجيل الأولي', desc: 'التحق الطالب بمسلك الصغار لبداية التهجئة والقراءة.', author: 'التسجيل والقبول' }
      ],
      goals: [
        { type: 'hifz', title: 'الحفظ الصباحي والتأكيد', target: 10, actual: 2, unit: 'صفحة', status: 'delayed', lastUpdated: '10/06/2026' }
      ],
      interventions: [
        { id: 'INT-03', type: 'improvement', title: 'تنفيذ خطة تحسين تربوي مع المعلم والأب', reason: 'صعوبات قراءة مكثفة تحول دون السبر التراكمي المعتمد.', authority: 'اللجنة التعليمية', date: '01/06/2026', status: 'active' }
      ],
      decisions: [
        { id: 'E-03', title: 'تقليص الخطة المنهجية للنصف وتغيير المسار', reason: 'صعوبة التعلم والتحفيظ الكثيف لتلاقي العبء الصفي.', auth: 'اللجنة المعيارية', date: '10/06/2026' }
      ],
      notes: [
        { id: '4', text: 'يعاني من خلل بالترديد المخارجي، ننصح بتحويله لدورة القاعدة النورانية في المقر الرئيسي للتعديل.', category: 'instructional', author: 'أ. محمد معوض النخيلي', date: '04/06/2026' }
      ],
      communicationLog: [],
      achievements: []
    },
    {
      ...
      joinDate: '11/02/1443',
      age: 17,
      parentName: 'ماجد بن فهد السديري',
      parentPhone: '0555987654',
      relationship: 'أب',
      school: 'مدارس الرياض النموذجية',
      academicIndicator: 'green',
      riskFlags: [],
      hifzRate: 100,
      muraajaaRate: 98,
      commitmentScore: 99,
      lastExamScore: 100,
      lastExamName: 'القرآن الكريم كاملاً برواية حفص عن عاصم',
      attendanceRate: 98,
      trend: 'stable',
      timeline: [
        { date: '11/02/1443', title: 'التسجيل الفعلي', desc: 'بدء مرحلة المراجعة المركزة وختم السبر النهائي.', author: 'إدارة الحلقات' },
        { date: '12/10/1446', title: 'تخريج وختام كامل القرآن', desc: 'تم الختم والحساب الرسمي لعلامات الحفص بحضور اللجنة العلمية برتبة ممتاز تفوق.', author: 'رئيس الملتقى' }
      ],
      goals: [
        { type: 'hifz', title: 'المراجعة والضبط لتسجيل الختم', target: 30, actual: 30, unit: 'جزء', status: 'achieved', lastUpdated: '12/10/2026' }
      ],
      interventions: [],
      decisions: [
        { id: 'E-04', title: 'ترشيحه للمسابقة المحلية الرسمية لحفظ القرآن', reason: 'إتمام كامل القرآن بجودة خارقة ومخارج متقنة.', auth: 'المدير العام للمركز', date: '15/10/1446' }
      ],
      notes: [
        { id: '5', text: 'طالب استثنائي في التدبر والتمسك بالقراءات العشر، يوصى به كمعيد في حلقات التحفيظ لثقته.', category: 'educational', author: 'أ. عبد الرحمن السعيد', date: '20/10/2026' }
      ],
      communicationLog: [],
      achievements: [
        { date: '12/10/1446', title: 'حفظ كتاب الله كاملاً ومنحه شهادة السند التمكيني', category: 'الختم النهائي' }
      ]
    },
    {
      id: 'ST-000006',
      ...
      joinDate: '30/08/1444',
      age: 15,
      parentName: 'صالح بن غانم الميمان',
      parentPhone: '0566234567',
      relationship: 'أب',
      ...
      commitmentScore: 90,
      lastExamScore: 91,
      lastExamName: 'اختبار الأجزاء الـ 20 التراكمية',
      attendanceRate: 93,
      trend: 'stable',
      timeline: [
        { date: '30/08/1444', title: 'التسجيل والقبول', desc: 'تم قبول الطالب والانخراط في خطة حفظ الأجزاء.', author: 'شؤون الطلاب' }
      ],
      goals: [
        { type: 'hifz', title: 'الحفظ والمطابقة الشهرية', target: 20, actual: 18, unit: 'صفحة', status: 'pending', lastUpdated: '19/06/2026' }
      ],
      interventions: [],
      decisions: [],
      notes: [
        { id: '6', text: 'مجتهد ومنضبط، عليه زيادة التركيز فقط في مراجعة المتشابهات القرأنية سورة الصافات ص.', category: 'educational', author: 'الشيخ عبد الرحمن السعيد', date: '14/06/2026' }
      ],
      communicationLog: [],
      achievements: []
    }
