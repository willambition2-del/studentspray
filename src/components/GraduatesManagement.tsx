...
export default function GraduatesManagement() {
  ...
  // Initial Graduate database
  const [graduates, setGraduates] = useState<Graduate[]>([
    {
      id: 'GR-000001',
      name: 'يزيد بن عبدالملك العريني',
      birthDate: '12/08/1428',
      age: 19,
      phone: '0551234567',
      email: 'yazeed.oraini@example.com',
      guardianName: 'عبدالملك بن محمد العريني',
      guardianPhone: '0501234567',
      graduationDate: '25/11/1446',
      circleGraduatedFrom: 'حلقة معاذ بن جبل النموذجية',
      teacher: 'أ. حازم عمر الحركي',
      studyDurationYears: 5,
      lastEducationalLevel: 'المستوى السادس (إتقان التلاوة والرواية)',
      lastCompletedPlan: 'خطة الخاتمين الفائقة',
      lastExamScore: 98,
      finalGrade: 'excellent',
      overallCompletionRate: 100,
      memorizedPartsCount: 30,
      certificatesCount: 3,
      awards: ['درع التميز لحفظ القرآن الكريم كاملاً', 'وسام الحافظ المتقن للعام 1446هـ'],
      badges: ['خاتم ممتاز', 'متابع نشط', 'داعم تقني'],
      competitions: ['مسابقة الملك سلمان المحلية لحفظ القرآن (المركز الثالث)'],
      notableParticipations: ['إمامة المصلين بصلاة التراويح لشهر رمضان 1446هـ'],
      history: [
        { date: '15/09/1441', event: 'التسجيل الأولي في الملتقى', description: 'تم قبول الطالب واختبار مستوى الحفظ البدائي (5 أجزاء)', category: 'registration' },
        { date: '10/05/1442', event: 'الانتقال لحلقة الحفظ المكثف', description: 'تم ترقيته نظراً لسرعة الحفظ والانضباط العالي', category: 'transfer' },
        { date: '01/01/1445', event: 'إتمام حفظ 15 جزءاً بنجاح', description: 'اجتياز اختبار منتصف القرآن الكريم بمعدل 95%', category: 'exam' },
        { date: '20/04/1446', event: 'الحصول على جائزة الطالب المثالي', description: 'تكريم رسمي من المشرف العام لتفوقه ومواظبته الكاملة', category: 'achievement' },
        { date: '25/11/1446', event: 'التخرج الختمي وإتمام الحفظ', description: 'تسميع الختمة كاملة في جلسة واحدة واجتياز الاختبار النهائي بنسبة 98%', category: 'graduation' },
      ],
      status: 'teacher',
      followUps: [
        {
          ...
          revisionStatus: 'excellent',
          memorizationContinuance: 'yes',
          participatingInCenter: true,
          newAchievements: 'الحصول على سند متصل برواية حفص عن عاصم',
          comments: 'الطالب ملتزم جداً بورد المراجعة اليومي ويقدم الدعم لزملائه بالحلقة',
          nextFollowUpDate: '10/07/1447'
        }
      ],
      assignments: [
        {
          id: 'AS-001',
          role: 'teaching',
          title: 'معلم مساعد بحلقة التميز المبتدئ',
          startDate: '01/12/1446',
          status: 'active',
          description: 'تولي تسميع ومراجعة الحفظ للطلاب المستجدين'
        }
      ],
      attachments: [
        { id: 'att-1', name: 'وثيقة تخرج_يزيد_العريني.pdf', type: 'pdf', size: '2.4 MB', date: '26/11/1446' },
        { id: 'att-2', name: 'صورة_الختمة_الذهبية.png', type: 'image', size: '1.8 MB', date: '25/11/1446' }
      ],
      isArchived: false
    },
    {
      id: 'GR-000002',
      name: 'عبدالرحمن بن نايف البقمي',
      birthDate: '04/03/1429',
      age: 18,
      phone: '0557654321',
      email: 'a.naif.buqami@example.com',
      guardianName: 'نايف بن صقر البقمي',
      guardianPhone: '0507654321',
      graduationDate: '14/10/1446',
      circleGraduatedFrom: 'حلقة مصعب بن عمير الفضية',
      teacher: 'أ. عبدالرحمن السعيد',
      studyDurationYears: 4,
      lastEducationalLevel: 'المستوى الخامس (تلاوة وضبط الحفظ)',
      lastCompletedPlan: 'خطة جودة الحفظ والمراجعة',
      lastExamScore: 94,
      finalGrade: 'very_good',
      overallCompletionRate: 100,
      memorizedPartsCount: 30,
      certificatesCount: 2,
      awards: ['شهادة التميز القرآني الكبرى'],
      badges: ['الحافظ المجتهد'],
      competitions: ['المسابقة الكبرى للجمعية الخيرية بالمنطقة'],
      notableParticipations: ['المشاركة في اللقاءات التعريفية السنوية للطلاب الجدد'],
      history: [
        { date: '10/10/1442', event: 'الالتحاق بالملتقى', description: 'البدء بمسار الضبط والحفظ من الجزء العاشر', category: 'registration' },
        { date: '15/02/1444', event: 'تغيير المعلم والانتقال لحلقة مصعب بن عمير', description: 'تنسيب الطالب للشيخ عبدالرحمن السعيد للضبط العالي', category: 'transfer' },
        { date: '14/10/1446', event: 'حفل تخرج الدفعة الذهبية', description: 'تكريم الطالب رسمياً وتخرجه وحفظه لكامل القرآن الكريم', category: 'graduation' },
      ],
      status: 'reviewing',
      followUps: [
        {
          ...
          revisionStatus: 'good',
          memorizationContinuance: 'partial',
          participatingInCenter: true,
          newAchievements: 'البدء في حفظ متن الجزرية لتجويد الأداء',
          comments: 'يرجى تكثيف تواصل المعلم لزيادة المراجعة اليومية حيث رصد بعض التردد في الأجزاء الوسطى',
          nextFollowUpDate: '15/03/1447'
        }
      ],
      assignments: [
        {
          id: 'AS-002',
          role: 'volunteering',
          title: 'عضو اللجنة التنظيمية للمخيم الصيفي',
          startDate: '10/11/1446',
          status: 'completed',
          description: 'متابعة شؤون تسكين وضيافة الوفود القرآنية المشاركة'
        }
      ],
      attachments: [
        { id: 'att-3', name: 'شهادة_إتمام_الحفظ.pdf', type: 'pdf', size: '1.9 MB', date: '15/10/1446' }
      ],
      isArchived: false
    },
    {
      id: 'GR-000003',
      name: 'مهند بن عبدالعزيز التميمي',
      birthDate: '19/11/1427',
      age: 20,
      phone: '0544567890',
      email: 'muhannad.t@example.com',
      guardianName: 'عبدالعزيز بن سليمان التميمي',
      guardianPhone: '0564567890',
      graduationDate: '09/07/1445',
      circleGraduatedFrom: 'حلقة الإمام الشاطبي للجودة',
      teacher: 'أ. فهد الدوسري',
      studyDurationYears: 6,
      lastEducationalLevel: 'المستوى السادس (الإجازة والقراءات)',
      lastCompletedPlan: 'مسار الإجازة المتصلة',
      lastExamScore: 97,
      finalGrade: 'excellent',
      overallCompletionRate: 100,
      memorizedPartsCount: 30,
      certificatesCount: 4,
      awards: ['وشاح الإجازة الكبرى بالروايات الثلاث'],
      badges: ['المجيز المعتمد', 'سفير الملتقى'],
      competitions: ['المسابقة الدولية بدبي لحفظ القرآن الكريم (مشارك)'],
      notableParticipations: ['الإشراف على لجان التحكيم بالمسابقة السنوية الفرعية'],
      history: [
        { date: '01/01/1439', event: 'التسجيل بملتقى الهدى', description: 'البدء من جزء عم والارتقاء المتتابع بحفظ القرآن', category: 'registration' },
        { date: '09/07/1445', event: 'الحصول على الإجازة والتخرج', description: 'أتم عرض القرآن كاملاً بروايتي حفص وشعبة وحصل على مرتبة الامتياز والسند المتصل', category: 'graduation' }
      ],
      status: 'supervisor',
      followUps: [],
      assignments: [
        {
          id: 'AS-003',
          role: 'supervision',
          title: 'مشرف جودة التعليم بالحلقات الصباحية',
          startDate: '15/08/1445',
          status: 'active',
          description: 'متابعة الخطط التعليمية وتقييم كفاءة المعلمين بالحلقة النموذجية'
        }
      ],
      attachments: [],
      isArchived: false
    ...
    {
      id: 'GR-000004',
      name: 'فيصل بن صالح المطيري',
      birthDate: '22/01/1429',
      age: 18,
      phone: '0533456789',
      email: 'faisal.m@example.com',
      guardianName: 'صالح بن ناصر المطيري',
      guardianPhone: '0503456789',
      graduationDate: '30/12/1444',
      circleGraduatedFrom: 'حلقة عثمان بن عفان التأسيسية',
      teacher: 'أ. حازم عمر الحركي',
      studyDurationYears: 3,
      lastEducationalLevel: 'المستوى الرابع (حفظ وضبط)',
      lastCompletedPlan: 'خطة الحفظ السريع الاستثنائي',
      lastExamScore: 89,
      finalGrade: 'good',
      overallCompletionRate: 100,
      memorizedPartsCount: 30,
      certificatesCount: 1,
      awards: ['جائزة الطالب العصامي الكبرى للضبط'],
      badges: ['خاتم متفوق'],
      competitions: [],
      notableParticipations: [],
      history: [
        { date: '11/04/1441', event: 'التسجيل بالملتقى', description: 'البدء بمسار مكثف حفظ الأجزاء', category: 'registration' },
        { date: '30/12/1444', event: 'التخرج والمغادرة المؤقتة', description: 'الحصول على شهادة إكمال حفظ القرآن الكريم كاملاً والالتحاق بجامعة الملك سعود', category: 'graduation' }
      ],
      status: 'external',
      followUps: [
        {
          ...
          date: '12/05/1445',
          intervalType: 'annual',
          revisionStatus: 'needs_improvement',
          memorizationContinuance: 'no',
          participatingInCenter: false,
          newAchievements: 'لا يوجد حالياً بسبب ضغط الدراسة الجامعية في السنة التحضيرية للطب',
          comments: 'تم رصد ضعف في التواصل وضعف في المراجعة بسبب الانشغال الأكاديمي والجامعي.',
          nextFollowUpDate: '12/05/1446'
        }
      ],
      assignments: [],
      attachments: [],
    ...
    {
      id: 'GR-000005',
      name: 'عبدالمحسن بن غازي الحربي',
      birthDate: '11/06/1428',
      age: 19,
      phone: '0599876543',
      email: 'm.harbi@example.com',
      guardianName: 'غازي بن سعيد الحربي',
      guardianPhone: '0509876543',
      graduationDate: '18/02/1443',
      circleGraduatedFrom: 'حلقة مصعب بن عمير الفضية',
      teacher: 'أ. عبدالرحمن السعيد',
      studyDurationYears: 5,
      lastEducationalLevel: 'المستوى الخامس (ضبط الأداء)',
      lastCompletedPlan: 'الخطة الفضية المتدرجة للطلاب الموهوبين',
      lastExamScore: 92,
      finalGrade: 'very_good',
      overallCompletionRate: 100,
      memorizedPartsCount: 30,
      certificatesCount: 2,
      awards: ['درع الملتقى للمشاركات الفعالة'],
      badges: ['مشارك متطوع'],
      competitions: [],
      notableParticipations: [],
      history: [
        { date: '10/01/1438', event: 'الانضمام للحلقات النموذجية الأولى', description: 'أحد أقدم الطلاب الملتحقين بالملتقى والمحافظين على الهوية والتميز', category: 'registration' },
        { date: '18/02/1443', event: 'حفل الختام والتخرج السنوي', description: 'تتويج الطالب بوشاح الخريج بعد إتمامه الحفظ والاختبار بمعدل 92%', category: 'graduation' }
      ],
      status: 'disconnected',
      followUps: [
        {
          ...
          memorizationContinuance: 'no',
          participatingInCenter: false,
          newAchievements: 'لم يتم رصد تواصل',
          comments: 'تعذر التواصل الهاتفي المتكرر مع الطالب أو ولي أمره، تم تصنيفه كمنقطع مؤقتاً.',
          nextFollowUpDate: '01/01/1446'
        }
      ],
      assignments: [],
      attachments: [],
      isArchived: true // Archived graduate
    }
  ]);
